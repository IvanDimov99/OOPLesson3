...
public class EmployeeFabric {
    ...
    public static Employee generateEmployee() {
        String[] names = new String[] { "Евгений", "Даниил", "Станислав", "Артем", "Михаил", "Николай", "Степан",
                "Игорь", "Алексей", "Сергей" };
        String[] surnames = new String[] { "Иванов", "Петров", "Смирнов", "Михайлов", "Федоров", "Соколов", "Кузнецов",
                "Попов", "Васильев", "Павлов" };
